...
arm::arm(int sweepMinBase, int sweepMaxBase, float angleMinBase, float angleMaxBase,
...
void arm::begin(int pinBase, int pinShoulder, int pinElbow, int pinGripper) {
  _pinBase = pinBase;
...
void arm::goDirectlyTo(float x, float y, float z) {
...
void arm::gotoPoint(float x, float y, float z) {
...
bool arm::isReachable(float x, float y, float z) {
  float radBase,radShoulder,radElbow;
